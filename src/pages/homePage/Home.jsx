...
// import { Container, Navbar, Nav, Row, Col, Carousel, Card, Button, Modal, Spinner } from 'react-bootstrap';
...
//     // Temporarily hide the "Add to Cart" button
...
//     setProductName(name); // Store the product name
//     setShowModal(true);
//   } catch (error) {
...
//         />
//         {!isSending && !sendSuccess && <p>Send this product image?</p>}
//         {isSending && (
...
//         )}
//         {sendSuccess && (
//           <div className="alert alert-success mt-2">Image sent successfully!</div>
//         )}
//       </>
//     )}
//   </Modal.Body>
...
// làm lại chức năng chia sẻ hình ảnh sản phẩm qua Zalo, sử dụng html-to-image để chụp ảnh sản phẩm và gửi qua Zaloimport React, { useState, useRef } from 'react';
